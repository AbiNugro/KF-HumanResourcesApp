        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Create Leave Request Data</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('leave-requests.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control date_flatpicker" name="start_date" required>
                            @error('start_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control date_flatpicker" name="end_date" required>
                            @error('end_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
