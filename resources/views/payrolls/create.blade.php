        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Create Payroll Employee</h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('payrolls.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Paydate</label>
                            <input type="date" class="form-control date_flatpicker" name="pay_date" required>
                            @error('pay_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
